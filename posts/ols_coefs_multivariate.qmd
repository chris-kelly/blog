...
Below is an interactive plot, that shows how the residuals change with the choice of coefficients. The RMSE for any particular choice of coefficients is shown in the title.
...
Finally, here is a surface plot of the RMSE given choices of $\beta_0$ and $\beta_1$, for the random sample.
