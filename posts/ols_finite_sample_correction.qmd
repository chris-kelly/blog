...
Imagine there are $N$ i.i.d random variables $X_1, X_2,...,X_n$[^3]., generated from a population process with mean $\mu$ and $\sigma$. Then we might derive the following:
