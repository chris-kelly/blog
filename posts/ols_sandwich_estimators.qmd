...
pd.DataFrame(
  np.hstack([
    our_mod.summary(correction="homoskedastic")['Standard Error'].to_numpy().reshape(-1,1),
...
pd.DataFrame(
  np.hstack([
    our_mod.summary(correction='heteroskedastic')['Standard Error'].to_numpy().reshape(-1,1),
...
pd.DataFrame(
  np.hstack([
    our_mod.summary(correction=cl)['Standard Error'].to_numpy().reshape(-1,1),
