...
```{python}
#| code-fold: true
#| code-summary: "Creating the gaussian base class"
...
```{python}
#| code-fold: true
#| code-summary: "Testing the gaussian regression"
...
```{python}
#| code-fold: true
#| code-summary: "Creating the Bernoulli base class"
...
```{python}
#| code-fold: true
#| code-summary: "Creating the poisson base class"
...
[^5]:
  $b(\xi_i)$ seems slightly odd at first: it is the integral of the activation function. It's easier to see this by running through each example:
  * Poisson: 
